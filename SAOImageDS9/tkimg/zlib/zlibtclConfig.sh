...
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/usr/local/src/SAOImageDS9/tkimg/zlib -lzlibtcl1.2.11'
...
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/usr/local/src/SAOImageDS9/tkimg/zlib -lzlibtclstub1.2.11'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/usr/local/src/SAOImageDS9/lib/zlibtcl1.2.11 -lzlibtclstub1.2.11'

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/usr/local/src/SAOImageDS9/tkimg/zlib/libzlibtclstub1.2.11.a'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/usr/local/src/SAOImageDS9/lib/zlibtcl1.2.11/libzlibtclstub1.2.11.a'
