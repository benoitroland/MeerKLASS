...
class ClassSolPredictMachine():
    def __init__(self,GD):
        ...
        CGiveSaveFileName=ClassGiveSolsFile.ClassGive_kMSFileName(MSName=MSName,GD=GD,SolsDir=SolsDir)
        FileName=CGiveSaveFileName.GiveFileName(SolsName=SolsName,Type="Sols")
