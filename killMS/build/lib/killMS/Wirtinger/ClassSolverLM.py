...
#         T.timeit("%i"%i)
        ...
        if self.DataAllFlagged:
            # print(self.iAnt)
            # print("  [%i] DataAllFlagged"%self.iAnt,self.DataAllFlagged)
            # print("      [%i] DataAllFlagged"%self.iAnt,self.DataAllFlagged)
            return Ga.reshape((self.NDir,self.NJacobBlocks_X,self.NJacobBlocks_Y)),None,{"std":-1.,"max":-1.,"kapa":None},0
